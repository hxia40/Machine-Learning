...
############################## neural network ##############################
    ...
    file_5.write("no of variable (base)" + ";")
    file_5.write("%i" % data1_X.shape[1])
    file_5.write("\n")
    file_5.write("scores_test_ANN_base" + ";")
    file_5.write("%1.9f" % scores_test_ANN_base)
    file_5.write("\n")
    file_5.write("elasped_time_1" + ";")
    file_5.write("%1.9f" % elasped_time_1_base)
    file_5.write("\n")
    file_5.write("no of variable (PCA)" + ";")
    file_5.write("%i" % data1_X_pca.shape[1])
    file_5.write("\n")
    file_5.write("scores_test_ANN_PCA" + ";")
    file_5.write("%1.9f" % scores_test_ANN_pca)
    file_5.write("\n")
    file_5.write("elasped_time_1" + ";")
    file_5.write("%1.9f" % elasped_time_1_pca)
    file_5.write("\n")
    file_5.write("no of variable (ICA)" + ";")
    file_5.write("%i" % data1_X_ica.shape[1])
    file_5.write("\n")
    file_5.write("scores_test_ANN_ICA" + ";")
    file_5.write("%1.9f" % scores_test_ANN_ica)
    file_5.write("\n")
    file_5.write("elasped_time_1" + ";")
    file_5.write("%1.9f" % elasped_time_1_ica)
    file_5.write("\n")
