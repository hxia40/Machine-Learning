...
class TradingEnv(gym.Env):
    ...
    def render_all(self, mode='human'):
        ...
        # for i, tick in enumerate(window_ticks):          # original, looks weird
        #     if self._position_history[i] == Positions.Short:
        #         short_ticks.append(tick)
        #     elif self._position_history[i] == Positions.Long:
        #         long_ticks.append(tick)

        for tick in range(len(self._position_history)-1):          # HX
            # print("and tick is:", tick)
            if self._position_history[tick] == Positions.Short:
                short_ticks.append(tick)
            elif self._position_history[tick] == Positions.Long:
                long_ticks.append(tick)
