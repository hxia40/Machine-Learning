...
############################## Decision Tree ##############################
    ...
    SGD_file = open('number_SGD.txt','w')
    ...
    plt.savefig('graph_SGD_1.png')

    SGD_file.write("scores_train_learning_DT1")
    for i in range(len(scores_train_learning_DT1)):
        SGD_file.write(";")
        SGD_file.write("%1.9f" % scores_train_learning_DT1[i])
        SGD_file.write("\n")
        SGD_file.write("scores_test_learning_DT1")
    for i in range(len(scores_test_learning_DT1)):
        SGD_file.write(";")
        SGD_file.write("%1.9f" % scores_test_learning_DT1[i])
    SGD_file.write("\n")
    ...
    plt.legend(loc='upper right');
    plt.savefig('graph_SGD_2.png')

    SGD_file.write("scores_train_learning_DT2")
    for i in range(len(scores_train_learning_DT2)):
        SGD_file.write(";")
        SGD_file.write("%1.9f" % scores_train_learning_DT2[i])
        SGD_file.write("\n")
    SGD_file.write("scores_test_learning_DT2")
    for i in range(len(scores_test_learning_DT2)):
        SGD_file.write(";")
        SGD_file.write("%1.9f" % scores_test_learning_DT2[i])
    SGD_file.write("\n")
    ...
    plt.legend(loc='upper right');
    plt.savefig('graph_SGD_3.png')

    SGD_file.write("scores_pruning_DT1")
    for i in range(len(scores_pruning_DT1)):
        SGD_file.write(";")
        SGD_file.write("%1.9f" % scores_pruning_DT1[i])
    SGD_file.write("\n")
    SGD_file.write("scores_pruning_DT2")
    for i in range(len(scores_pruning_DT2)):
        SGD_file.write(";")
        SGD_file.write("%1.9f" % scores_pruning_DT2[i])
    SGD_file.write("\n")
    ...
    SGD_file.write("%i" % n2)
    SGD_file.write("\n")
    SGD_file.write("train_n1" + ";")
    SGD_file.write("%i" % train_n1)
    SGD_file.write("\n")
    SGD_file.write("train_n2" + ";")
    SGD_file.write("%i" % train_n2)
    SGD_file.write("\n")
    SGD_file.write("optimal_leaf_size_1" + ";")
    SGD_file.write("%1.9f" % temp_n[np.argmax(scores_pruning_DT1)])
    SGD_file.write("\n")
    SGD_file.write("optimal_leaf_size_2" + ";")
    SGD_file.write("%1.9f" % temp_n[np.argmax(scores_pruning_DT2)])
    SGD_file.write("\n")
    SGD_file.write("scores_train_DT1" + ";")
    SGD_file.write("%1.9f" % scores_train_DT1)
    SGD_file.write("\n")
    SGD_file.write("scores_test_DT1" + ";")
    SGD_file.write("%1.9f" % scores_test_DT1)
    SGD_file.write("\n")
    SGD_file.write("scores_train_DT2" + ";")
    SGD_file.write("%1.9f" % scores_train_DT2)
    SGD_file.write("\n")
    SGD_file.write("scores_test_DT2" + ";")
    SGD_file.write("%1.9f" % scores_test_DT2)
    SGD_file.write("\n")
    SGD_file.write("elasped_time_1" + ";")
    SGD_file.write("%1.9f" % elasped_time_1)
    SGD_file.write("\n")
    SGD_file.write("elasped_time_2" + ";")
    SGD_file.write("%1.9f" % elasped_time_2)
    SGD_file.close()
